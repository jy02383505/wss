 ...
 * pdo对象定义查询函数
 */
function Q($sql, $oper='query', $hostname_tankdb, $database_tankdb, $username_tankdb, $password_tankdb){
    $hostname_tankdb = $hostname_tankdb ? : $GLOBALS[hostname_tankdb];
    $database_tankdb = $database_tankdb ? : $GLOBALS[database_tankdb];
    $username_tankdb = $username_tankdb ? : $GLOBALS[username_tankdb];
    $password_tankdb = $password_tankdb ? : $GLOBALS[password_tankdb];
