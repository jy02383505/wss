...
// *** 数据字典开始(系统正式运行后禁止修改数据字典)********************
  // *网站配置
$multilingual_global_sitetitle = "久联任务项目管理系统";
...
// *** 登录页面(user_login.php)
$multilingual_userlogin_title = "登录管理";
...
$multilingual_taskadd_totip = "任务执行人";
...
$multilingual_project_member = "项目成员";
...
<br />
<p>角色为禁用的用户，将被禁止登录系统，适用于已经离开团队的成员；另外，当您需要删除一个用户时，请谨慎操作，用户一旦被删除，与其相关的所有数据将无法查询，为了保证数据的完整性，我们强烈建议将其角色改为“禁用”，而非直接删除用户。</p>
<br />
...
$multilingual_exam_tip = "任务负责人，任务审核人";
...
// *** login
$multilingual_getqrcode = "<br />使用微信扫描二维码，或搜索公众帐号wsspmis，即可使用WSS移动版<br /><br />
